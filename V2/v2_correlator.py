...
erc20transfer_events = load("./v2_erc20transfer_events.json")
#(tx_hash,block,sender,receiver,amount)
transfer_events = load("./v2_transfer_events.json")
...
import csv
with open("v2_correlation.csv", 'w', newline='') as csvfile:
