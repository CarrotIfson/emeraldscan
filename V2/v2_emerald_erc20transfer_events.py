...
if __name__ == '__main__':
    ...
    with open("./v2_erc20transfer_events.json", "w") as file:
        json.dump(list(erc20transfer_events), file)

    #build ledger
    erc20transfer_ledger = {}
    #key: address
    #value: (in_tx_count, out_tx_count, amount_in, amount_out, balance, [txs])
    ...
    with open("./v2_erc20transfer_ledger.json", "w") as file:
